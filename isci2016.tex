...
Solved Experiments:
	\begin{figure}
		\subfloat[Weights change in Exp1]{
			\centering
			\includegraphics[width=0.25\textwidth]{exp1_weights_s_perfect}
			\label{fig:exp1_weights_s_perfect}}\\
		\subfloat[Weights change in Exp1]{
				\centering
				\includegraphics[width=0.25\textwidth]{exp1_recon_s_perfect}
				\label{fig:exp1_recon_s_perfect}}\\
		\subfloat[Weights change in Exp1]{
				\centering
				\includegraphics[width=0.25\textwidth]{exp1_hid_s_perfect}
				\label{fig:exp1_hid_s_perfect}}										
	\caption{Experiments 1 \& 2.}
	\end{figure}
